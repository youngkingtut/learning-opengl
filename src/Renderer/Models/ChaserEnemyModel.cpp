...
void ChaserEnemyModel::loadStatic() {
...
void ChaserEnemyModel::draw(const ChaserEnemy &enemy, const GLuint& modelViewMatrixLocation, const GLuint& colorLocation) {
    glBindVertexArray(vertexArrayObject);

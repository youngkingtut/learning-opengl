...
void ChaserEnemy::setNextPosition(const ControlState &controlState, const GameState &worldState, const float &deltaTime) {
...
bool ChaserEnemy::bulletCollision(Bullet &bullet) {

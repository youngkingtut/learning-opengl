...
void SimpleEnemy::setNextPosition(const ControlState &controlState, const GameState &worldState, const float &deltaTime) {
...
bool SimpleEnemy::bulletCollision(Bullet &bullet) {
